...
#if (defined(IAR))
	__ramfunc void set_sys_dividers(unsigned long int outdiv1, unsigned long int outdiv2, unsigned long int outdiv3, unsigned long int outdiv4);
#elif (defined(CW))
	__relocate_code__ 
	void set_sys_dividers(unsigned long int outdiv1, unsigned long int outdiv2, unsigned long int outdiv3, unsigned long int outdiv4);
#endif	
